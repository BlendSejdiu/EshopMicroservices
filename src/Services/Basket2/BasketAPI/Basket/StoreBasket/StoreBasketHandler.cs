...
namespace BasketAPI.Basket.StoreBasket
{
    ...
    public class StoreBasketHandler(IBasketRepository _repository, DiscountProtoService.DiscountProtoServiceClient discountProto) : ICommandHandler<StoreBasketCommand, StoreBasketResult>
    {
